<!-- Con entangle se vincula la variable de livewire(Navigation.php) con la de alpinejs -->
<!-- el .defer es para que no se envie una peticion al servidor cada que cambie la variable -->
